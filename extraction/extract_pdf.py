    ...
    table_data = tabula.read_pdf(
        ...
        area=[
            ...
            [
                ...
                (ref[1] + 0.0 + set_swap),
                (ref[0] + 98.8),
                (ref[1] + 118.8 + set_swap),
            ],  # * +303 pour set 5
            [
                (ref[0] + 56.7),
                (ref[1] + 0.0 + team_diff),
                (ref[0] + 98.6),
                (ref[1] + 118.8 + team_diff),
            ],
            [
                (ref[0] + 64.6),
                (ref[1] + 118.3 + set_swap),
                (ref[0] + 91.5),
                (ref[1] + 155.1 + set_swap),
            ],  # * +303 pour set 5
            [
                (ref[0] + 64.6),
                (ref[1] + 118.3 + team_diff),
                (ref[0] + 91.5),
                (ref[1] + 155 + team_diff),
            ],
        ],
        columns=[
            ref[1] + column_size * 1 + set_swap,
            ref[1] + column_size * 2 + set_swap,
            ref[1] + column_size * 3 + set_swap,
            ref[1] + column_size * 4 + set_swap,
            ref[1] + column_size * 5 + set_swap,
            ref[1] + column_size * 6 + set_swap,
            ref[1] + team_diff + column_size * 1,
            ref[1] + team_diff + column_size * 2,
            ref[1] + team_diff + column_size * 3,
            ref[1] + team_diff + column_size * 4,
            ref[1] + team_diff + column_size * 5,
            ref[1] + team_diff + column_size * 6,
        ],
        pages="1",
    )
    return table_data
...
def extract_set(ref, set_nb, title_data, table_data, verbose=False):
    ...
    if not title_data or not table_data:
        print("Empty set at (" + str(ref[0]) + ", " + str(ref[1]) + ") : KO") if (
            verbose == True
        ) else 0
    ...
    time_string = time_data.columns.values[0][
        time_data.columns.values[0].index(" ") + 1 :
    ]
    ...
    print("Parsing set at (" + str(ref[0]) + ", " + str(ref[1]) + ") : OK") if (
        verbose == True
    ) else 0
    return set_data
...
def extract_4calls(file, verbose=False):
    ...
    ref_list = [(73.4, 127.4), (73.4, 462.7), (167, 128.2), (167, 461.5), (261.4, 28.1)]
    ref_team = [(261, 575.3), (261, 703.5)]
    team_diff = 155
    set_swap = 303
    team_diff_5 = 135.1
    col = 8
    ...
    query_1 = tabula.read_pdf(
        ...
        area=[
            ...
            [
                (ref_list[0][0] + 3.6),
                (ref_list[0][1] + team_diff),
                (ref_list[0][0] + 13.7),
                (ref_list[0][1] + 154.3 + team_diff),
            ],
            # * Set 2 [10:11]
            [
                (ref_list[1][0] + 3.6),
            ...
            [
                (ref_list[1][0] + 3.6),
                (ref_list[1][1] + team_diff),
                (ref_list[1][0] + 13.7),
                (ref_list[1][1] + 154.3 + team_diff),
            ],
            # * Set 3 [12:13]
            [
                (ref_list[2][0] + 3.6),
            ...
            [
                (ref_list[2][0] + 3.6),
                (ref_list[2][1] + team_diff),
                (ref_list[2][0] + 13.7),
                (ref_list[2][1] + 154.3 + team_diff),
            ],
            # * Set 4 [14:15]
            [
                (ref_list[3][0] + 3.6),
            ...
            [
                (ref_list[3][0] + 3.6),
                (ref_list[3][1] + team_diff),
                (ref_list[3][0] + 13.7),
                (ref_list[3][1] + 154.3 + team_diff),
            ],
            # * Time string [16]
            ...
            [
                (ref_list[4][0] + 3.6),
                (ref_list[4][1] + team_diff_5),
                (ref_list[4][0] + 13.7),
                (ref_list[4][1] + 154.3 + team_diff_5),
            ],
            #        #* Result tab [16-18?]
    ...
    if (
        (not format_check.equals(format_ref))
        or (query_1[8].columns.values[0] == "Début:")
        or (query_1[10].columns.values[0] == "Début:")
    ):
    ...
    query_2 = tabula.read_pdf(
        ...
        area=[
            ...
            [
                (ref_list[0][0] + 15.2),
                (ref_list[0][1] + 0.0 + team_diff),
                (ref_list[0][0] + 57),
                (ref_list[0][1] + 119 + team_diff),
            ],
            [
                (ref_list[0][0] + 56.7),
                (ref_list[0][1] + 0.0),
            ...
            [
                (ref_list[0][0] + 64.6),
                (ref_list[0][1] + 118.3 + team_diff),
                (ref_list[0][0] + 91.5),
                (ref_list[0][1] + 155 + team_diff),
            ],
            # * Set 2 [6:11]
            [
                (ref_list[1][0] + 14.0),
            ...
            [
                (ref_list[1][0] + 15.2),
                (ref_list[1][1] + 0.0 + team_diff),
                (ref_list[1][0] + 57),
                (ref_list[1][1] + 119 + team_diff),
            ],
            [
                (ref_list[1][0] + 56.7),
                (ref_list[1][1] + 0.0),
            ...
            [
                (ref_list[1][0] + 64.6),
                (ref_list[1][1] + 118.3 + team_diff),
                (ref_list[1][0] + 91.5),
                (ref_list[1][1] + 155 + team_diff),
            ],
            # * Set 3 [12:17]
            [
                (ref_list[2][0] + 14.0),
            ...
            [
                (ref_list[2][0] + 15.2),
                (ref_list[2][1] + 0.0 + team_diff),
                (ref_list[2][0] + 57),
                (ref_list[2][1] + 119 + team_diff),
            ],
            [
                (ref_list[2][0] + 56.7),
                (ref_list[2][1] + 0.0),
            ...
            [
                (ref_list[2][0] + 64.6),
                (ref_list[2][1] + 118.3 + team_diff),
                (ref_list[2][0] + 91.5),
                (ref_list[2][1] + 155 + team_diff),
            ],
            # * Set 4 [18:23]
            [
                (ref_list[3][0] + 14.0),
            ...
            [
                (ref_list[3][0] + 15.2),
                (ref_list[3][1] + 0.0 + team_diff),
                (ref_list[3][0] + 57),
                (ref_list[3][1] + 119 + team_diff),
            ],
            [
                (ref_list[3][0] + 56.7),
                (ref_list[3][1] + 0.0),
            ...
            [
                (ref_list[3][0] + 64.6),
                (ref_list[3][1] + 118.3 + team_diff),
                (ref_list[3][0] + 91.5),
                (ref_list[3][1] + 155 + team_diff),
            ],
        ],
        columns=[
            ref_list[0][1] + column_size * 1,
            ref_list[0][1] + column_size * 2,
            ref_list[0][1] + column_size * 3,
            ref_list[0][1] + column_size * 4,
            ref_list[0][1] + column_size * 5,
            ref_list[0][1] + column_size * 6,
            ref_list[0][1] + team_diff + column_size * 1,
            ref_list[0][1] + team_diff + column_size * 2,
            ref_list[0][1] + team_diff + column_size * 3,
            ref_list[0][1] + team_diff + column_size * 4,
            ref_list[0][1] + team_diff + column_size * 5,
            ref_list[0][1] + team_diff + column_size * 6,
            ref_list[1][1] + column_size * 1,
            ref_list[1][1] + column_size * 2,
            ref_list[1][1] + column_size * 3,
            ref_list[1][1] + column_size * 4,
            ref_list[1][1] + column_size * 5,
            ref_list[1][1] + column_size * 6,
            ref_list[1][1] + team_diff + column_size * 1,
            ref_list[1][1] + team_diff + column_size * 2,
            ref_list[1][1] + team_diff + column_size * 3,
            ref_list[1][1] + team_diff + column_size * 4,
            ref_list[1][1] + team_diff + column_size * 5,
            ref_list[1][1] + team_diff + column_size * 6,
        ],
        pages="1",
    )
    if len(query_2) == 22:
    ...
    query_3 = tabula.read_pdf(
        ...
        columns=[
            ...
            276.5,
            304.7,
            ref_team[0][1] + team_column_size[0],
            ref_team[0][1] + team_column_size[1],
            ref_team[0][1] + team_column_size[2],
            ref_team[1][1] + team_column_size[0],
            ref_team[1][1] + team_column_size[1],
            ref_team[1][1] + team_column_size[2],
        ],
        pages="1",
    )
...
def extract_team(title_data, table_data, ref, verbose=False):
    ...
    if team_data[0] == "xxxxx":
        print("Empty team at (" + str(ref[0]) + ", " + str(ref[1]) + ") : KO") if (
            verbose == True
        ) else 0
        return [0, 0, 0, 0]
    ...
    print("Parsing Team at (" + str(ref[0]) + ", " + str(ref[1]) + ") : OK") if (
        verbose == True
    ) else 0
    return team_data
...
def extract_title(table_data, verbose=False):
    ...
    time_string = table_data[6].columns.values[0][
        table_data[6].columns.values[0].index(" ") + 1 :
    ]
    time_string = translate_month(time_string)
...
if __name__ == "__main__":
    ...
    debug = os.path.join(
        os.path.dirname(__file__), "../data/2019-2020/N3F.C/3FC022.pdf"
    )
    timer = Timer()
