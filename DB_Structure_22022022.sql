...
CREATE TABLE `club` (
  ...
  `comite` varchar(100) DEFAULT NULL,
  `ligue` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`club_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1672 DEFAULT CHARSET=latin1;


-- sport_analytics.club_licence_histo definition

CREATE TABLE `club_licence_histo` (
  `club_licence_histo_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `club_id` int(10) unsigned NOT NULL,
  `saison_id` varchar(100) NOT NULL,
  `total_m` int(10) unsigned DEFAULT NULL,
  `total_f` int(10) unsigned DEFAULT NULL,
  `jeune_m` int(10) unsigned DEFAULT NULL,
  `jeune_f` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`club_licence_histo_id`)
) ENGINE=InnoDB AUTO_INCREMENT=6596 DEFAULT CHARSET=utf8mb4;
...
-- sport_analytics.live_match definition

CREATE TABLE `live_match` (
  `live_match_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `match_number` varchar(100) NOT NULL,
  PRIMARY KEY (`live_match_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


-- sport_analytics.live_match_action definition

CREATE TABLE `live_match_action` (
  `live_match_action_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `player_id` varchar(100) NOT NULL,
  `action_id` int(10) unsigned NOT NULL,
  `answer_id` int(10) unsigned NOT NULL,
  `score` varchar(100) DEFAULT NULL,
  `placment` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`live_match_action_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


-- sport_analytics.live_match_player definition

CREATE TABLE `live_match_player` (
  `live_match_player_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `live_match_id` int(10) unsigned NOT NULL,
  `player_id` varchar(100) NOT NULL,
  PRIMARY KEY (`live_match_player_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


-- sport_analytics.live_settings definition

CREATE TABLE `live_settings` (
  `live_settings_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `score` tinyint(4) NOT NULL,
  `placment_split` varchar(45) NOT NULL,
  PRIMARY KEY (`live_settings_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


-- sport_analytics.live_settings_action definition

CREATE TABLE `live_settings_action` (
  `live_settings_action_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned NOT NULL,
  `action_name` varchar(100) NOT NULL,
  `active` tinyint(4) NOT NULL,
  PRIMARY KEY (`live_settings_action_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;


-- sport_analytics.live_settings_answer definition

CREATE TABLE `live_settings_answer` (
  `live_settings_answer_id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `action_id` int(10) unsigned NOT NULL,
  `answer_name` varchar(100) NOT NULL,
  `active` tinyint(4) NOT NULL,
  PRIMARY KEY (`live_settings_answer_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
