...
foreach($dir1 as $dir) {
	...
	foreach($folders as $folder) {
		...
		foreach($files as $countFile => $file) {
			...
			$inversed = ($sets['Teams']['Set 1']['Name']['Team A'] != substr($teams['Name']['Team 1'][0], 0, 22));
			$inversed5 = ($sets['Teams']['Set 5']['Name']['Team A'] != substr($teams['Name']['Team 1'][0], 0, 19));	
