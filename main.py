    ...
    for parent, dirnames, filenames in os.walk('./data'):
        for fn in tqdm(filenames, ncols=90, desc=parent+" :"):
            ...
            if fn.lower().endswith('.pdf'):
                ...
                output_folder = os.path.join(os.path.dirname(__file__), out_folder+parent.split(folder)[1])
...
def print_usage():
    ...
    print("     folder:             Name of input folder, in relative to the script folder")
    print("     -a, --all:          Enable overwriting of existing outputs, default=False")
    print("     -o <output_folder>: Name of input folder, in relative to the script folder")
    print("     -i, --ignore:       Ignoring all errors going through files, default=True")
