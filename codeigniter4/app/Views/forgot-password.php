                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    <div class="text-center">
                                        ...
                                        <p class="mb-4">Nous comprenons, ce sont des choses qui arrivent. Il suffit d’entrer votre adresse e-mail ci-dessous
et nous vous enverrons un lien pour réinitialiser votre mot de passe!</p>
                                    ...
                                    <div class="text-center">
                                        <a class="small" href="Connexion">Déjà un compte? Connexion!</a>
                                    </div>
                                </div>
                            </div>
                        </div>
